...
contract Certify {        
    ...
    modifier certificationExists(string _ipfsHash) {require(mapCertificationInstitution[_ipfsHash] != address(0x0)); _;} //check if certification exists
    ...
    */
    ...
    /** @dev Returns the a certification created by an institution. Only accesible to institutions
        ...
        */
    function getInstitutionCertification(uint _index) public view isInstitution returns (string _ipfsHash) {
    ...
    /** @dev Returns the a certification issued to a student. Only accesible to student or everyone if allowed
        ...
        * @return _ipfsHash IPFS hash associated to a certification
        */
    function getStudentCertification(address _addrStudent, uint _index) public view returns (string ipfsHash, uint timeMiliseconds, uint score, string ipfsHashInstitutionInfo) {   
